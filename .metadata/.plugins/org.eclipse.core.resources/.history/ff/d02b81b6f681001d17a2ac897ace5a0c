...
h_calib_buffer_structure_t color_sensor1_buffer_calibration;
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin){
	if(GPIO_Pin==button_Pin){
		printf("----- appui bouton -----\r\n");
		color_sensor_init(&color_sensor1, GREEN,CENT_POUR_CENT,SENSOR_ENABLE);
...
int main(void)
{
  ...
  printf("color sensor initialized\r\nwaiting for button press : \r\n");*/
  	...
  	color_sensor_init(&color_sensor1, GREEN,CENT_POUR_CENT,SENSOR_DISABLE);
  	color_handle_calibration_sensor(&color_sensor1,&color_sensor1_buffer_calibration);
