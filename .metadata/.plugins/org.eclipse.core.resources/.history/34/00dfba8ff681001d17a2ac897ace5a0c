...
/**
 * @fn uint32_t color_getGreenValue(h_color_sensor_t * h_color_sensor)
...
/**
 * @fn uint32_t color_getRedValue(h_color_sensor_t * h_color_sensor)
...
/**
 * @fn void color_sensor_handle_input_capture_IT(h_color_sensor_t * h_color_sensor, TIM_TypeDef* TIM,h_calib_buffer_structure_t * h_calib_buffer_struct);
...
/**
 * @fn uint32_t color_handle_calibration_sensor(h_color_sensor_t * h_color_sensor,h_calib_buffer_structure_t * h_calib_struct);
 * @brief handle the input capture interruption. Manage if the sensor is being operated of calibrated
 *
 * @param h_color_sensor : color_sensor structure
 * @param h_calib_buffer_struct : buffer calibration structure used in case of the sensor being calibrated
 * @return 0 if failed else 1
 */
uint32_t color_handle_calibration_sensor(h_color_sensor_t * h_color_sensor,h_calib_buffer_structure_t * h_calib_struct);
